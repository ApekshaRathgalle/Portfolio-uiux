...
import { ArrowLeft, ExternalLink, Calendar, Users, Target, TrendingUp, Palette, CheckCircle } from 'lucide-react';
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center space-y-6">
            <motion.div
              ...
              className="w-20 h-20 bg-emerald-100 rounded-3xl flex items-center justify-center mx-auto"
            >
              ...
              {processSteps.map((step, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`${step.bg} p-6 rounded-xl text-center group cursor-pointer border-2 border-transparent hover:border-emerald-200 transition-all duration-300`}
                  >
                    <motion.div
          ...
          <motion.div variants={itemVariants} className="bg-gray-50 p-8 rounded-2xl">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
              <Palette className="w-6 h-6 text-emerald-600 mr-3" />
              Tools & Technologies
            </h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {project.technologies.map((tool, index) => (
                <motion.div
                  ...
                  className="p-4 bg-white rounded-xl text-center shadow-sm border-2 border-transparent hover:border-emerald-200 transition-all duration-300"
                >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {project.features.map((feature, index) => (
                <motion.div
                  ...
                  className="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl group cursor-pointer border-2 border-transparent hover:border-emerald-200 transition-all duration-300"
                >
                  <motion.div
